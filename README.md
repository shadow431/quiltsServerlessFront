...
TODO List
Kitchen Items:
Add size drop-down bowl wrap
Add descriptions for items on thumbnail

Embroidery:
Drop tsl
Check Norwich/Norwegian

Alphabet searching

add cats to embroidery
thumbnails for dog and cat choice

create new products page

separate cat and dog fabric to own category
