...
export default function EmbroideryHome(props) {
  ...
  const graphicCategories = ["abd", "afg", "air", "aki", "asc", "atr", "aus", "baj", "bas", "bch", "bea", "bed", "bel", "ber", "bic", "bld", "bls", "blt", "bod", "bor", "bos", "bov", "box", "brc", "brd", "brr", "brt", "bru", "btc", "bul", "cah", "can", "cat", "chc", "che", "chi", "cho", "clb", "col", "cor", "cos", "cot", "dal", "ddt", "dob", "dox", "egs", "eng", "esk", "fbl", "flt", "fox", "gol", "gor", "grd", "grp", "grs", "gry", "gsm", "hav", "hus", "ice", "irh", "irw", "itg", "iwh", "jrt", "jpc", "kcs", "ker", "kes", "lab", "lad", "lag", "lak", "leo", "lgm", "lhp", "mal", "mas", "min", "mor", "new", "nor", "nov", "pap", "pek", "pic", "pit", "plh", "pod", "pom", "por", "pug", "pul", "rat", "rod", "rot", "sal", "sam", "sch", "sci", "sco", "sha", "shb", "she", "shi", "shl", "sil", "smc", "spr", "stb", "stf", "tib", "tre", "vis", "wei", "whi", "wht", "wip", "wfx", "wdd", "yor"];
